...
def main():
    ...
    try:
        ...
        print(json.dumps({"blurred_image_url_links":blurred_result,
                            "activation_id": str(activation_id),
                            "parts": parts
                            
                        }))

        return({"blurred_image_url_links":blurred_result,
                "activation_id": str(activation_id),
                "parts": parts})
        ...
        for i in range(0,parts):
            ...
            cv2.imwrite(output_image, blurred_image)
            blurred_result.append('blurred_image_'+str(i)+'.jpg')
        print("Blurred image",blurred_result)
        ...
        print(json.dumps({"blurred_image_url_links":url_list,
                            "activation_id": str(activation_id),
                            "parts": parts
                            # "aws_s3_processing_time": end-start
