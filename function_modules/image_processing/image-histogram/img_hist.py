...
# of the tonal distribution in a digital image. It plots the number
# of pixels for each tonal value
...
def main():
    ...
    try:
        ...
        print(json.dumps({"histogram_image_url_links":histogram_result,                       
                        "activation_id": str(activation_id),
                        "parts": parts
                        }))

        return({"histogram_image_url_links":histogram_result,            
            "activation_id": str(activation_id),
            "parts": parts
